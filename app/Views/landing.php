...
<html lang="en">
	...
	<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" class="bg-white position-relative">
		...
		<div class="d-flex flex-column flex-root">
			...
			<?= $this->include('public/sections/header'); ?>
			<!--end::Header Section-->
			<!--begin::How It Works Section-->
			<?= $this->include('public/sections/aboutus'); ?>
			<!--end::How It Works Section-->
			<!--begin::Statistics Section-->
			<?= $this->include('public/sections/users'); ?>
			<!--end::Statistics Section-->
			<!--begin::Team Section-->
			<?= $this->include('public/sections/team'); ?>
			<!--end::Team Section-->
			
			<!--begin::Footer Section-->
			<?= $this->include('public/sections/footer'); ?>
			<!--end::Footer Section-->
			<!--begin::Scrolltop-->
