<div id="kt_header" class="header align-items-stretch" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
    ...
    <div class="header-container container-xxl d-flex align-items-center">
        ...
        <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
            <a href="/dashboard">
                <img alt="Logo" src="/assets/media/logos/logo-dark.png" class="theme-light-show d-none d-lg-block h-45px" />
                <img alt="Logo" src="/assets/media/logos/logo-dark.png" class="theme-dark-show d-none d-lg-block h-45px" />
            ...
            <div class="d-flex align-items-stretch" id="kt_header_nav">
                ...
                <div class="header-menu align-items-stretch h-lg-75px" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
                    ...
                    <div class="menu menu-rounded menu-sub-indention menu-column menu-lg-row menu-active-bg menu-title-gray-700 menu-arrow-gray-400 menu-state-primary fw-semibold my-5 my-lg-0 px-2 px-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                        ...
                        <!--begin:Menu item-->
                        <div data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion menu-here-bg me-0 me-lg-2">
                            <!--begin:Menu link-->
                            <span class="menu-link py-3">
                                <a href="/dashboard"><span class="menu-title">Dasbor</span></a>
                            </span>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <!--begin:Menu item-->
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                            <!--begin:Menu link-->
                            <span class="menu-link py-3">
                                ...
                                <div class="menu-state-bg menu-extended" data-kt-menu-dismiss="true">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="/video-latihan" class="menu-link">
                                                            ...
                                                            <span class="d-flex flex-column">
                                                                <span class="fs-6 fw-bold text-gray-800">Video Latihan</span>
                                                                <span class="fs-7 fw-semibold text-muted">Endurance</span>
                                                            </span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    </div>
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        ...
                                                        <a href="/pasien" class="menu-link">
                                                            ...
                                                            <span class="d-flex flex-column">
                                                                <span class="fs-6 fw-bold text-gray-800">Pasien</span>
                                                                <span class="fs-7 fw-semibold text-muted">CoFit Rehab</span>
                                                            </span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    </div>
                                        ...
                                        <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
                                            <!--begin:Heading-->
                                            <h4 class="fs-6 fs-lg-4 text-gray-800 fw-bold mt-3 mb-3 ms-4">Menu lain</h4>
                                            <!--end:Heading-->
                                            <!--begin:Menu item-->
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="/settings" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="#" class="menu-link py-2 signoutBtn">
            ...
            <div class="topbar d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-3 ms-lg-5" id="kt_header_user_menu_toggle">
                    ...
                    <div class="btn btn-icon w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img class="h-100 w-100 rounded" src="/assets/media/avatars/blank.png" alt="" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5"><?= $users->username ?>
                                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span></div>
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7"><?= $users->role_name ?></a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
                        ...
                        <div class="menu-item px-5">
                            <a href="/settings" class="menu-link px-5">Pengaturan</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu separator-->
                        <div class="separator my-2"></div>
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="/logout" class="menu-link px-5 signoutBtn">Keluar</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
                ...
                <div class="d-flex align-items-center d-lg-none ms-4" title="Show header menu">
                    <div class="btn btn-icon btn-color-gray-900 w-30px h-30px w-md-40px h-md-40px" id="kt_aside_toggle">
