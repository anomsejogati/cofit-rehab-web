...
<html lang="en">
	...
	<body id="kt_body" class="app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="d-flex flex-lg-row-fluid">
					...
					<div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
						<!--begin::Image-->
						<img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="assets/media/auth/reset.png" alt="" />
						<img class="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="assets/media/auth/reset.png" alt="" />
						<!--end::Image-->
						<!--begin::Title-->
						<h1 class="text-gray-800 fs-2qx fw-bold text-center mb-7">Atur Ulang Kata Sandi</h1>
						<!--end::Title-->
						<!--begin::Text-->
						<div class="text-gray-600 fs-base text-center fw-semibold">Halaman aplikasi untuk 
						<a href="#" class="opacity-75-hover text-primary me-1">atur ulang kata sandi dokter</a>. <br>
				...
				<div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12">
					...
					<div class="bg-body d-flex flex-center rounded-4 w-md-600px p-10">
						...
						<div class="w-md-400px">
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" id="kt_password_reset_form" data-kt-redirect-url="../../demo12/dist/authentication/layouts/overlay/new-password.html" action="#">
								<!--begin::Heading-->
								...
								<div class="d-flex flex-wrap justify-content-center pb-lg-0">
									...
									<a href="/sign-in" class="btn btn-light">Batal</a>
								</div>
								<!--end::Actions-->
							</form>
							<!--end::Form-->
		...
		<script src="dists/reset_password.js?v=<?= date('YmdHis'); ?>"></script>
